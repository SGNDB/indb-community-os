...
const labelsForLocale: Record<string, Record<string, string>> = {
  ar: {
    ...
    chooseMethodHint: "اختر طريقة الدفع المناسبة لإتمام التبرع",
    confirmText: "أؤكد رغبتي في التبرع لهذا المشروع.",
    confirmButton: "تأكيد التبرع",
    submitting: "جاري الإرسال...",
    thankYou: "شكراً لك ❤️",
    successMessage: "تم استلام طلب التبرع بنجاح. سيتم التحقق من عملية الدفع وإشعارك فور اعتمادها.",
    notificationHint: "ستصلك إشعارات فور اعتماد التبرع.",
    ...
    comingSoon: "قريباً",
    backToCampaigns: "العودة للحملات",
  ...
  fr: {
    ...
    chooseMethodHint: "Choisissez votre moyen de paiement pour effectuer le don",
    confirmText: "Je confirme mon don pour ce projet.",
    confirmButton: "Confirmer le don",
    submitting: "Envoi en cours...",
    thankYou: "Merci ❤️",
    successMessage: "Votre demande de don a été reçue avec succès. Le paiement sera vérifié et vous serez notifié dès son approbation.",
    notificationHint: "Vous serez notifié dès l'approbation du don.",
  ...
  en: {
    ...
    chooseMethodHint: "Choose your payment method to complete the donation",
    confirmText: "I confirm my donation for this project.",
    confirmButton: "Confirm donation",
    submitting: "Submitting...",
    thankYou: "Thank you ❤️",
    successMessage: "Your donation request has been received successfully. The payment will be verified and you will be notified once approved.",
    notificationHint: "You will be notified once the donation is approved.",
