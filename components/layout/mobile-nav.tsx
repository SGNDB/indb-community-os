          ...
          return (
            <li key={item.href}>
              <Link
                ...
                className={cn(
                  "group flex min-h-14 flex-1 flex-col items-center justify-center rounded-xl px-0.5 py-1 text-xs font-medium transition",
                  active
                    ? "text-primary"
                    : "text-muted-foreground hover:bg-muted/70 hover:text-foreground",
                )}
              >
                {Icon ?                 <Icon size={24} className={cn("transition", active ? "scale-105" : "group-hover:scale-105")} /> : null}
